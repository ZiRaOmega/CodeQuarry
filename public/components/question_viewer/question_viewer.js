  ...
  .then((data) => {
    data.forEach((question) => {
      ...
      upvoteContainer[0].onclick = function () {
        ...
        if (upvoteContainer[0].style.backgroundColor == "rgb(104, 195, 163)") {
      ...
      if (question.responses != null) {
        ...
        question.responses.forEach((answer) => {
          ...
          question_viewer__answers__answer.setAttribute(
            "data-answer-id",
            answer.response_id
          );
          ...
          question_viewer__answers__answer.appendChild(vote_responseContainer);
          if (answer.is_author) {
            console.log("ghjklmù");
